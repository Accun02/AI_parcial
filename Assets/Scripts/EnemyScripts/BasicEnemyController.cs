...
public class BasicEnemyController : MonoBehaviour
{
    ...
    private void OnInin()
    {
        ...
        var qgoingtodestination = new QuestionTree(() => waypointController.checkdistancetowaypoint(), waitorcontinuepatrolling, patrol); // Si est・yendo en direcci al Waypoint, o si no, empieza a Patrol de nuevo.
